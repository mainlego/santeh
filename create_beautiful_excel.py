...
for row_idx, product in enumerate(processed_products, 2):
    ...
    cell_e = ws.cell(row=row_idx, column=5, value=params.get('country', 'Россия'))
...
# Сохраняем файл
wb.save('template_petrovich_BEAUTIFUL.xlsx')

print("СОЗДАН КРАСИВЫЙ EXCEL!")
print("Файл: template_petrovich_BEAUTIFUL.xlsx")
print("\nОсобенности дизайна:")
print("+ Артикул на первом месте")
print("+ Цветовое оформление заголовков")
print("+ Увеличенная высота строк для описаний")
print("+ Группировка колонок (Упаковка/Изделие)")
print("+ Границы и выравнивание")
print("+ Замороженные заголовки")